...
const loadBoard = async () => {
  const url = makeUrl();
  if (!accessToken || !url) { setRows([]); setLoading(false); return; }
  setLoading(true);
  try {
  ...
  return (
    <div className="leaderboard-container">
      ...
      <div className="leaderboard-header">
        ...
        {me && <div style={{ color: "#666", fontSize: 13 }}>Signed in as {me.email}</div>}
      </div>
      ...
      >
        ...
        {!loading && rows.map((r) => (
          <div key={r.id} className="card" style={{
            ...
            <div style={{ position: "relative", paddingTop: "62%", background: "#fafafa" }}>
              <img
            ...
            <div style={{ padding: 12, display: "flex", flexDirection: "column", gap: 6 }}>
              ...
              {r.description && (
                <div style={{ color: "#555", fontSize: 14, lineHeight: 1.3 }}>{r.description}</div>
              )}
