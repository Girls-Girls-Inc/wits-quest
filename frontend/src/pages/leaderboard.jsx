    ...
    <div className="container active">
      ...
      >
        ...
        >
          ...
          <div className="btn" style={{ display: "inline-flex", width: "auto" }}>
            <IconButton
              type="button"
              icon="refresh"
        ...
        <div style={{ overflowX: "auto" }}>
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            ...
            <tbody>
              {loading && (
                <tr>
                  <Td colSpan={4} style={{ textAlign: "center", padding: 18, color: "#666" }}>
                    Loading…
                  </Td>
                </tr>
              )}
              ...
              {!loading &&
                rows.map((r, i) => (
                  <tr key={r.id ?? `${i}`} style={{ borderTop: "1px solid #2a2a2a" }}>
                    <Td>
                      <strong>{i + 1}</strong>{" "}
                      {i < 3 && (
                        <span
                    ...
                    <Td>{r.points}</Td>
                    <Td>
                      <code style={{ fontSize: 12, wordBreak: "break-all" }}>{r.id}</code>
                    </Td>
                  </tr>
                ))}
            </tbody>
